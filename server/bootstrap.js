...
Meteor.startup(function () {
    if (Anatomy.find().count() === 0) {
        var data = [
            {name: "Lungs",     image: 'lungs1.png'},
            {name: "Knee",      image: 'knee.png'},
            {name: "Kidneys",   image: 'kidneys.png'},
            {name: "Brain",     image: 'brain1.png'},
            {name: "Teeth",     image: 'dental.png'},
            {name: "Ear",       image: 'ear1.png'},
            {name: "Eye",       image: 'eye1.png'}
        ];
